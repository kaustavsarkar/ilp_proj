...
<p align="center">
<a href="<%=request.getContextPath()%>/JSP/additems.jsp">Add Items</a><br>
<a href="<%=request.getContextPath()%>/AdminController?action=viewitems">view and update  items</a><br>

<br>


<%--- <a href="<%=request.getContextPath()%>/JSP/updateitems.jsp">update items</a><br> 

<a href="<%=request.getContextPath()%>/JSP/deleteitems.jsp">delete items</a><br>
--%>
</p>
</div>
