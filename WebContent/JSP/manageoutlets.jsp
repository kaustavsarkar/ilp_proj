...
<p align="center">
<a href="<%=request.getContextPath()%>/JSP/addOutlet.jsp">ADD OUTLETS</a><br></br>
<a href="<%=request.getContextPath()%>/AdminController?action=viewoutlets">VIEW ALL OUTLET</a><br></br>
</p>
