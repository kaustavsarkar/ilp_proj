...
Thank you!!!
<br><br>
<% int dl=Integer.parseInt(request.getAttribute("delete").toString());
if(dl!=0)
{
	%>
	 Customer details is deleted.
	click <a href="<%=request.getContextPath()%>/JSP/admin.jsp">Admin Home</a>
	<%
	
	}
	else{ %>
	Customer is not deleted.Plz try again later.
	click <a href="<%=request.getContextPath()%>/JSP/admin.jsp">Admin Home</a>
