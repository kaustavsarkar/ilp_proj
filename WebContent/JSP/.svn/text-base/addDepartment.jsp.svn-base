...
<p><strong>Add Departments</strong></p>
</header>

<div align="center">
	<form  onsubmit="return validatedepartment()" name="addDepartment" action="<%=request.getContextPath()%>/AdminController">
		<table align="center">
	
			<tr>
				<td>Department Name  <input type="text" name="departmentname" id="departmentname"></td>
			</tr>
			<tr> 
