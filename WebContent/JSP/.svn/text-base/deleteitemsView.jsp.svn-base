...
%>
<form name="deleteitems" onsubmit="return deleteitem()" method="post" action="<%=request.getContextPath()%>/AdminController">
<table align="center">
<tr><td>ITEM ID</td><td><input type="text" name="itemid" value="<%=items.getItemId() %>" readonly></td></tr>
<tr><td>ITEM NAME</td><td><input type="text" name="itemname" value="<%=items.getItemName() %>"readonly></td></tr>
<%
...
if(items.getDepartmentId()==dept.getDepartmentId()){
	%>
	<td><input type="text" name="departmentid" value="<%=dept.getDepartmentName()%>"readonly></td></tr>
	<%
}
	}
%>
...
<tr><td>DEPARTMENT ID</td><td><input type="text" name="departmentid" value="<%=items.getDepartmentId() %>"readonly></td></tr> 
--%>
<tr><td>PRICE</td><td><input type="text" name="price" value="<%=items.getPrice() %>"readonly></td></tr>
<tr><td>QUANTITY</td><td><input type="text" name="quantity" value="<%=items.getQuantity() %>"readonly></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="DELETE">
</table>
