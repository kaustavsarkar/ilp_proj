...
<%--<a href="<%=request.getContextPath()%>/JSP/addDepartment.jsp">Add Department</a><br></br>--%>
<a href="<%=request.getContextPath()%>/AdminController?action=viewdepartments">View All Departments</a><br></br>
