...
<ul><%request.getSession().invalidate(); %>
	...
	<li class="current"><a href="<%=request.getContextPath()%>/JSP/admin.jsp">Admin Page</a></li>
...
<p><strong>Customer Status</strong></p>
</header>

<body>

<h2 align="center"><b>Customer Deleted</b></h2>
<a href="<%= request.getContextPath()%>/AdminController?action=viewcustomersdetail">View Customer Details</a><br></body>
<%---<a href="<%= request.getContextPath()%>/CustomerAdminController?action=deletejsp&Id=1">Delete Customer Details</a>
 --%>
