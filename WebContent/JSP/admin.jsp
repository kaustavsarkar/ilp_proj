...
<div ><p align="center">
<a href="<%=request.getContextPath()%>/JSP/manageitems.jsp">Manage Items</a><br>
<a href="<%=request.getContextPath()%>/JSP/managedepartment.jsp">Manage Departments</a><br>
<a href="<%=request.getContextPath()%>/JSP/manageoutlets.jsp">Manage Outlets</a><br>
<a href="<%= request.getContextPath()%>/AdminController?action=viewcustomersdetail">View Customer Details</a><br>
